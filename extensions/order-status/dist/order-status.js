(() => {
  ...
  // extensions/order-status/src/OrderStatus.jsx
...
${errorInfo.componentStack}`);
  ...
  var OrderStatus_default = reactExtension(
  ...
  function Extension() {
    ...
    const [nsOrderData, setNsOrderData] = (0, import_react18.useState)(null);
    const [nsTracking, setNsTracking] = (0, import_react18.useState)(null);
    const [nsInstructions, setNsInstructions] = (0, import_react18.useState)(null);
    const [deliveryMethod, setDeliveryMethod] = (0, import_react18.useState)(null);
    ...
    function fetchOrderInfo(esId, orderId, mode) {
      ...
      if (mode == "test") {
        apiUrl = `${baseUrl}&gid=${orderId}&mode=test`;
      }
      fetch(apiUrl, {
        method: "GET",
        mode: "cors",
        ...
        if (data) {
          ...
          data.shed_instructions[0].shed_model !== void 0 && setNsInstructions(data.shed_instructions);
        } else {
    ...
    (0, import_react18.useEffect)(() => {
      ...
      const testMode = (_a = mf.find((item) => item.metafield.key === "test_mode")) == null ? void 0 : _a.metafield.value;
      const testGid = (_b = mf.find((item) => item.metafield.key === "test_gid")) == null ? void 0 : _b.metafield.value;
      if (order_id[4] == 1) {
        const liveGid = (_c = mf.find((item) => item.metafield.key === "live_gid")) == null ? void 0 : _c.metafield.value;
        fetchOrderInfo("", liveGid, "test");
      } else if (testMode == "true" && order_id[4] == testGid) {
        const liveGid = (_d = mf.find((item) => item.metafield.key === "live_gid")) == null ? void 0 : _d.metafield.value;
        fetchOrderInfo("", liveGid, "test");
      } else {
        fetchOrderInfo(spOrderId.name, order_id[4], "order");
      }
    }, []);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: nsOrderData !== null && nsOrderData !== "error" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { cornerRadius: "loose", padding: "loose", background: "subdued", children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: "2", children: nsOrderData.status_contents.title }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: nsOrderData.status_contents.body }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: nsOrderData.status_contents.footer }),
        nsTracking && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: nsTracking, external: true, children: "Track your Order" }),
        deliveryMethod == "Click&Collect" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "base" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { emphasis: "bold", children: "Your Click and Collect Location" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { children: [
            " ",
            nsOrderData.click_and_collect.address,
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: nsOrderData.click_and_collect.url, external: true, children: "Map" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: `tel:${nsOrderData.click_and_collect.phone}`, external: true, children: nsOrderData.click_and_collect.phone }) })
        ] }) : deliveryMethod == "Home Delivery" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, {}),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "base" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { emphasis: "bold", children: "Your Delivery Address" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: nsOrderData.shipping_address.shipping_addressee }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: nsOrderData.shipping_address.shipping_addrtext }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: nsOrderData.shipping_address.shipping_phone })
        ] }) : ""
      ] }),
      nsInstructions !== null && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockSpacer2, { spacing: "loose" }),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { cornerRadius: "loose", padding: "loose", background: "subdued", children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: "2", children: "Easyshed Assembly Instructions" }),
          /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: "You can download your Assembly Instructions and Concrete Slab Dimensions to help you kick start your build before your shed arrives." }),
          nsOrderData.shed_instructions.map((product, index) => /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(TextBlock2, { emphasis: "bold", children: [
              product.shed_model,
              ": "
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: product.link, external: true, children: "Assembly Instructions" }),
            " / ",
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Link2, { to: product.slab_link, external: true, children: "Concrete Slab Dimensions" }, `slab-${index}`)
          ] }, index))
        ] })
      ] })
    ] }) : nsOrderData === "error" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, {}) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Spinner2, {}) });
  }
})();
